                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildFilterOption(
                        'Sort By',
                        selectedSortOrder,
                        ['Most Recent', 'Least Recent', 'Most Helpful'],
                        (value) {
...
void _showRatingDialog({Map<String, dynamic>? reviewData, String? reviewId}) {
  ...
  if (reviewData != null) {
    ...
    // Map Firestore URLs to XFile objects
    selectedImages = (reviewData['photoUrls'] ?? [])
        .map<XFile>((url) => XFile(url)) // Treat Firestore URLs as XFile
        .toList();
  }
